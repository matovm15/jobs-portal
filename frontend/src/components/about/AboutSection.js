      ...
      <div className="auto-container">
        <div className="row">
            ...
            >
              <div className="sec-title">
                ...
                <div className="text">
                  ...
                  estimate. Read reviews on over 600,000 companies worldwide.
                </div>
              </div>
          ...
          <div className="image-column col-lg-6 col-md-12 col-sm-12">
            <figure
              className="image wow fadeInLeft animated"
              style={{ visibility: "visible", animationName: "fadeInLeft" }}
            >
              <img src="images/resource/image-2.jpg" alt="" />
            </figure>
            <div
              className="count-employers wow fadeInUp animated"
              style={{ visibility: "visible", animationName: "fadeInUp" }}
            >
              ...
              <figure className="image">
                <img src="images/resource/multi-logo.png" alt="" />
              </figure>
            </div>
          </div>
        </div>

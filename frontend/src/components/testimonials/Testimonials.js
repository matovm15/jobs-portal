  ...
  return (
    <section className="testimonial-section">
      <div className="container-fluid">
        ...
        <div
          className="carousel-outer wow fadeInUp animated"
        ...
        >
          <div className="testimonial-carousel owl-carousel owl-theme owl-loaded owl-drag">
            <div className="owl-stage-outer">
              ...
              >
                <div className="owl-item cloned" style={{ width: "610px", marginRight: "15px" }}>
                  <div className="testimonial-block">
                    <div className="inner-box">
                      <h4 className="title">Great quality!</h4>
                      <div className="text">
                        Without JobHunt i’d be homeless, they found me a job and got me sorted out
                        quickly with everything! Can’t quite… The Mitech team works really hard to
                ...
                <div className="owl-item active" style={{ width: "610px", marginRight: "15px" }}>
                  <div className="testimonial-block">
                    <div className="inner-box">
                ...
                <div className="owl-item" style={{ width: "610px", marginRight: "15px" }}>
                  <div className="testimonial-block">
                    <div className="inner-box">
                      <h4 className="title">Great quality!</h4>
                      <div className="text">
